...
This folder contains the commands that would ease your shell usage using multiple implementations of command line tools. [Let's make using the terminal easy.](alias-shell-customization/)

## **File Transfer Using The Terminal**
While wired transfer is cool and all, but I'm lazy and paranoid, So I don't hand out my drives. What if I didn't have to? Check out how you can do it [here.](direct-wireless-file-sharing/)
